...
open class FPNTextField: UITextField {
    ...
    @objc open var flagButtonSize: CGSize = CGSize(width: 42, height: 42) {
        didSet {
            layoutIfNeeded()
        }
    }
    @objc open var flagDownArrowSize: CGSize = CGSize(width: 20, height: 42) {
        didSet {
            layoutIfNeeded()
        }
    }
    ...
    private var flagDownArrowWidthConstraint: NSLayoutConstraint?
    private var flagDownArrowHeightConstraint: NSLayoutConstraint?

    /// The size of the leftView
    private var leftViewSize: CGSize {
        let width = flagButtonSize.width + getWidth(text: phoneCodeTextField.text!) + flagDownArrowSize.width
    ...
    open var flagDownArrowButton: UIButton = UIButton()
    open var bottomLine: UIView = UIView()
    ...
    private func setupFlagButton() {
        flagButton.imageView?.contentMode = .scaleToFill
        flagButton.accessibilityLabel = "flagButton"
        flagButton.isUserInteractionEnabled = false
        flagButton.translatesAutoresizingMaskIntoConstraints = false
        flagButton.imageEdgeInsets = UIEdgeInsets(top: 0, left: 4, bottom: 0, right: 0)
    }
    
    private func setupFlagDownArrowButton() {
        flagDownArrowButton.imageView?.contentMode = .scaleAspectFit
        flagDownArrowButton.setImage(UIImage(named:"flagDownArrow", in: Bundle.FlagIcons, compatibleWith: nil), for: .normal)
        flagDownArrowButton.translatesAutoresizingMaskIntoConstraints = false
        flagDownArrowButton.imageEdgeInsets = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 4)
        flagDownArrowButton.isUserInteractionEnabled = false
    }
    ...
    private func setupLeftView() {
        ...
        flagButton.backgroundColor = UIColor(hexString: "#FDEBED")
        flagDownArrowButton.backgroundColor = UIColor(hexString: "#FDEBED")
        phoneCodeTextField.backgroundColor = UIColor(hexString: "#FDEBED")
        bottomLine.backgroundColor = UIColor(hexString: "#EA3A4F")
        bottomLine.translatesAutoresizingMaskIntoConstraints =  false
        
        leftView?.addSubview(flagButton)
        leftView?.addSubview(phoneCodeTextField)
        leftView?.addSubview(flagDownArrowButton)
        leftView?.addSubview(bottomLine)
        
        let tapGesuture = UITapGestureRecognizer(target: self, action: #selector(displayCountries))
        leftView?.addGestureRecognizer(tapGesuture)
        ...
        flagDownArrowWidthConstraint = NSLayoutConstraint(item: flagDownArrowButton, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 0, constant: flagDownArrowSize.width)
        flagDownArrowHeightConstraint = NSLayoutConstraint(item: flagDownArrowButton, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 0, constant: flagDownArrowSize.height)

        flagDownArrowWidthConstraint?.isActive = true
        flagDownArrowHeightConstraint?.isActive = true
        ...
        NSLayoutConstraint(item: phoneCodeTextField, attribute: .trailing, relatedBy: .equal, toItem: leftView, attribute: .trailing, multiplier: 1, constant: -20).isActive = true
        NSLayoutConstraint(item: phoneCodeTextField, attribute: .top, relatedBy: .equal, toItem: flagButton, attribute: .top, multiplier: 1, constant: 0).isActive = true
        NSLayoutConstraint(item: phoneCodeTextField, attribute: .bottom, relatedBy: .equal, toItem: flagButton, attribute: .bottom, multiplier: 1, constant: 0).isActive = true
        
        NSLayoutConstraint(item: flagDownArrowButton, attribute: .centerY, relatedBy: .equal, toItem: leftView, attribute: .centerY, multiplier: 1, constant: 0).isActive = true
        NSLayoutConstraint(item: flagDownArrowButton, attribute: .leading, relatedBy: .equal, toItem: phoneCodeTextField, attribute: .trailing, multiplier: 1, constant: 0).isActive = true
        NSLayoutConstraint(item: flagDownArrowButton, attribute: .trailing, relatedBy: .equal, toItem: leftView, attribute: .trailing, multiplier: 1, constant: -4).isActive = true
        
        
        NSLayoutConstraint(item: bottomLine, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 1).isActive = true
        
        NSLayoutConstraint(item: bottomLine, attribute: .leading, relatedBy: .equal, toItem: leftView, attribute: .leading, multiplier: 1, constant: 0).isActive = true
        NSLayoutConstraint(item: bottomLine, attribute: .trailing, relatedBy: .equal, toItem: flagDownArrowButton, attribute: .trailing, multiplier: 1, constant: 0).isActive = true
        NSLayoutConstraint(item: bottomLine, attribute: .top, relatedBy: .equal, toItem: flagButton, attribute: .bottom, multiplier: 1, constant: 0).isActive = true
...
extension UIColor {
    ...
    static func fadeColorAnimation(firstColor: UIColor, secondColor: UIColor, percent: CGFloat) -> UIColor {
        let c1 = CIColor(color: firstColor)
        let c2 = CIColor(color: secondColor)
